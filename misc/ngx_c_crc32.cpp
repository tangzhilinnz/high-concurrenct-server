...
CCRC32::~CCRC32() 
{
	ngx_log_stderr(0, "~CCRC32() executed, "
...
{
	//This is the official polynomial used by CRC-32 in PKZip, 
	//WinZip and Ethernet. 
	...
	for(int i = 0; i <= 0xFF; i++)
	{
        ...
        //if (i == 1)
		//	printf("old1--i=%d,crc32_table[%d] = %lu\r\n",i,i,crc32_table[i]);
		...
		for (int j = 0; j < 8; j++)
        {
			...
			crc32_table[i] = (crc32_table[i] << 1) ^ 
				(crc32_table[i] & (1 << 31) ? ulPolynomial : 0);
            //if (i == 1)
			//printf("old3--i=%d,crc32_table[%d] = %lu\r\n",i,i,crc32_table[i]);
        }
        //if (i == 1)
		//printf("old2--i=%d,crc32_table[%d] = %lu\r\n",i,i,crc32_table[i]);
